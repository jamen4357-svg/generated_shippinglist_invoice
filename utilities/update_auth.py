...
def update_page_auth(file_path, page_name, admin_required=False):
    ...
    try:
        ...
        admin_setup = f"""from src.auth.auth_wrapper import setup_page_auth
...
"""
        ...
        regular_setup = f"""from src.auth.auth_wrapper import setup_page_auth
...
user_info = setup_page_auth(
    ...
    layout="wide"
                ...
                new_content = re.sub(import_pattern, 'from src.auth.auth_wrapper import setup_page_auth', new_content)
